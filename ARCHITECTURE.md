...
**WIP limit: one implementation phase in progress, one plainly described next.** The decision-0046 runtime-authority sequence, including Telegram admission settlement concentration, is implemented and automated-test verified; no live Telegram smoke evidence was produced for these cycles. ACP external agents under decision 0044 is now the next approved carve.
