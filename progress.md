...
- [ ] `bun init`, scaffold `src/`, install `grammy` + `pi-coding-agent`.
- [ ] Env loader (`MODEL_*`, `BOT_TOKEN`, `ALLOWED_TG_USER_IDS`, `GOBLIN_HOME`).
- [ ] Long-polling bot with user-id allowlist middleware. Non-allowed users → silent drop.
