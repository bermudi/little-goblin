...
# 0003: Main Goblin Prompt Ownership Is Explicit

> Amended by decision 0039: this record's description of `SOUL.md` as *deployment-owned* refers to its role as the required identity source, not write authority. Goblin may rewrite `SOUL.md`, `AGENTS.md`, and `HEARTBEAT.md` with ordinary file tools during a user-facing turn. Prompt layering, required/optional semantics, and disabled pi context-file discovery are unchanged.
...
- Historical delivery record: `specs/changes/archive/2026-06-09-goblin-system-prompt/`
- `glossary.md` entries: `SOUL.md`, `product shell`, `project guidance`
