...
3. The operator can delegate bounded work to pi subagents or external-agent execution hosts while Goblin retains the owning lifetime and durable run record.
