// Vendored from OpenClaw memory-core (https://github.com/openclaw/openclaw).
// Copyright (c) OpenClaw contributors
// SPDX-License-Identifier: MIT
//
// This is a reference copy of the original algorithm source. It is not imported
// by little-goblin runtime code; the active implementation lives in src/memory/ and
// inlines the required helpers.
