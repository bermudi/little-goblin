...
# 0004: Goblin Is One Assistant — Project Mode Is A Capability, Not A Product
...
- `decisions/0002-topic-ui-is-user-owned.md` — the topic-mutation rule
  this decision upholds in code.
- `decisions/0003-main-goblin-prompt-ownership.md` — already establishes
...
- `specs/changes/archive/2026-07-03-dissolve-rename-topic/` — historical
  delivery record for the `rename_topic` dissolution.
