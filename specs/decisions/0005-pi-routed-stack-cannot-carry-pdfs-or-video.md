...
# 0005: PDFs And Video Cannot Reach The Model Through The Pi-Routed Stack
...
- Historical `multimodal-native-pdf` proposal — deleted from the working tree; recover with `git log --all -- specs/changes/multimodal-native-pdf/`.
- Historical `migrate-to-ai-sdk` proposal — deleted from the working tree; recover with `git log --all -- specs/changes/migrate-to-ai-sdk/`.
